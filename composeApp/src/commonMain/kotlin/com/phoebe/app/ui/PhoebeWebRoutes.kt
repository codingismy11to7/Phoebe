...
internal fun phoebeWebRoutesForPath(path: String?): List<PhoebeRoute> {
    val segments = path
        .orEmpty()
        .substringBefore("?")
        .substringBefore("#")
...
internal fun phoebePathSlug(value: String): String {
...
internal fun encodePhoebePathSegment(value: String): String = buildString {
...
internal fun decodePhoebePathSegment(value: String): String {
