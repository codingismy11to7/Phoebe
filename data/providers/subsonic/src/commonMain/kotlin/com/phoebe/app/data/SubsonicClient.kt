...
val NavidromeAllMusicLibrary = MusicLibrary("all", "All Music")

const val SubsonicQuickSyncAlbumTrackBatch = 40

const val SubsonicPlayHistoryAlbumListSize = 50

data class SubsonicSongPlayStat(
    val track: Track,
    val playCount: Long,
